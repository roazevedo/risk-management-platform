...
export const RISK_RESIDUAL_LEVELS = [
    'critical',
    'high',
    'medium',
    'low',
...
// Labels para exibição dos níveis de risco residual
export const RISK_RESIDUAL_LABELS: Record<string, string> = {
    'critical': 'Crítico',
    'high': 'Alto',
    'medium': 'Médio',
    'low': 'Baixo',
